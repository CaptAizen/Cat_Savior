...
public class GateControllerLeft : MonoBehaviour
{
    ...
    private IEnumerator OpenGateRight()
    {
        ...
        {
            float step = Mathf.Lerp(0.1f, openSpeedRight, Mathf.Abs(currentAngle / targetAngle)) * Time.deltaTime;
            currentAngle -= step;
            ...
            if (gateAudioSource != null)
            {
                gateAudioSource.volume = Mathf.Lerp(1f, 0.1f, Mathf.Abs(currentAngle / targetAngle));
            }
