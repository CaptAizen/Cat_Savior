...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Metal")]
    public class SteamAudioGeometryMetal : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Metal");
        }
