...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Plaster")]
    public class SteamAudioGeometryPlaster : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Plaster");
        }
