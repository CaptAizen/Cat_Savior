...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Carpet")]
    public class SteamAudioGeometryCarpet : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Carpet");
        }
