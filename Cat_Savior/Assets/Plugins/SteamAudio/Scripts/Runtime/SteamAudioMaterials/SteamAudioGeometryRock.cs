...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Rock")]
    public class SteamAudioGeometryRock : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Rock");
        }
