...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Wood")]
    public class SteamAudioGeometryWood : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Wood");
        }
