...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Glass")]
    public class SteamAudioGeometryGlass : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Glass");
        }
