...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Ceramic")]
    public class SteamAudioGeometryCeramic : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Ceramic");
        }
