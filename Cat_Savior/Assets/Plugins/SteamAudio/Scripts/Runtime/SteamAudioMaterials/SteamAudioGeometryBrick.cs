...
{
    [AddComponentMenu("Steam Audio/Steam Audio Geometry Brick")]
    public class SteamAudioGeometryBrick : MonoBehaviour
    {
        ...
        {
            return Resources.Load<SteamAudioMaterial>("Materials/Brick");
        }
